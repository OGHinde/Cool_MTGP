...
from scipy.linalg import pinv, inv, cholesky, cho_solve, solve_triangular
...
class MultitaskGP:
    ...
    def predict_efficient(self, X):
        ...
        return m_star.reshape((n_tst, T), order='F')


    def predict(self, X, conf_intervals=True):
